...
CREATE TABLE orders(
	...
	id_user BIGINT NULL,
	nombre_cuidador VARCHAR(300) NULL,
	popularidad_cuidador VARCHAR(300) NULL,
	precio_x_hora_cuidador VARCHAR(300) NULL,
	precio_x_hora_paseador VARCHAR(300) NULL,
	imagen_trabajador VARCHAR(300) NULL,
	precio_total VARCHAR(300) NULL,
	nombre_perrito VARCHAR(300) NULL,
	raza_perrito VARCHAR(300) NULL,
	fecha_cuidado VARCHAR(300) NULL,
	hora_inicio VARCHAR(300) NULL,
	horas_servicio VARCHAR(300) NULL,
	direccion_cliente VARCHAR(300) NULL,
	referencia_cliente VARCHAR(300) NULL,
	tipo_trabajador VARCHAR(300) NULL,
